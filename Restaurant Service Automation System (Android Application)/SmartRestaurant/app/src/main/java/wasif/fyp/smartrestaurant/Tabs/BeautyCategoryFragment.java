...
public class BeautyCategoryFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_beauty_category, container, false);
        ...
        RequestBody id_a = RequestBody.create(MediaType.parse("text/plain"), "9");
...
quantity =1;
    ...
    public void nextcall(int i,int j, int k, int l) {
        ...
        ApiInterface service1 = retrofit1.create(ApiInterface.class);
        Call<GeneralModel> user1 = service1.addorder(pass,   id_res,aa,adre);
        user1.enqueue(new Callback<GeneralModel>() {
            @RequiresApi(api = Build.VERSION_CODES.JELLY_BEAN_MR1)
            @Override
