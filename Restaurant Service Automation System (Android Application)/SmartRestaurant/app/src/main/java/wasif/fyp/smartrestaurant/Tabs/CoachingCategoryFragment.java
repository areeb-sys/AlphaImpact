...
public class CoachingCategoryFragment extends Fragment {
    ...
    public CoachingCategoryFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_coaching_category, container, false);
        ...
        RequestBody id_a = RequestBody.create(MediaType.parse("text/plain"), "7");
