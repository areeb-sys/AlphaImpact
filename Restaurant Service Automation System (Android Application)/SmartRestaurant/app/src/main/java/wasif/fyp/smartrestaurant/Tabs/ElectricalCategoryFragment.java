...
public class ElectricalCategoryFragment extends Fragment {
    ...
    public ElectricalCategoryFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_electrical_category, container, false);
        ...
        RequestBody id_a = RequestBody.create(MediaType.parse("text/plain"), "6");
