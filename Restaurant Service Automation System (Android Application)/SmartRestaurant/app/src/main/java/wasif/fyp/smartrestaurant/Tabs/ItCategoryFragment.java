...
public class ItCategoryFragment extends Fragment {
    List<FoodItem> arrayList = new ArrayList<>();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_it_category, container, false);
        ...
        RequestBody id_a = RequestBody.create(MediaType.parse("text/plain"), "11");
                                ...
                                public void onInject(final ItCategoryFragment.FoodItem data, IViewInjector injector) {
                                    ...
                                    injector.clicked(R.id.add, new View.OnClickListener() {
                                        ...
                                        public void onClick(View view) {
                                            ...
                                            Toast.makeText(getActivity(), "Clicked : "+ mSharedPreferences.getString(PREF_ORDERID, ""), Toast.LENGTH_SHORT).show();

                                            nextcall(Integer.valueOf(mSharedPreferences.getString(PREF_ORDERID, "")), data.getPrice(), data.getFoodItemID(), quantity);
                                        }
                                    });
    ...
    public void nextcall(Integer i, Integer j, Integer k, Integer l) {
        Retrofit retrofit1 = new Retrofit.Builder()
                .baseUrl(getResources().getString(R.string.URL))
                .addConverterFactory(GsonConverterFactory.create())
                .build();
